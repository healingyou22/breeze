                ...
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form" action="{{ route('login') }}">
                            ...
                            <div class="form-group form-button btn-right">

                                <button type="submit" name="signin" id="signin" class="form-submit">{{ __('Log in') }}</button>
                            </div>
                            <a href="#" class="forget-image-link">Forget Password</a>
                        </form>
                    </div>
                </div>
            </div>
